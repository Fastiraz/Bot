...
#
    ...
    #        title=f"**Music**",
    #        description=f"Musicord is playing: {query}",
    #        color=0xff7979
    #    )
    ...
    async def yt(self, ctx, *, url):
        ...
        embed=nextcord.Embed(
            title=f"**Music**",
            description=f"> Musicord is playing: {player.title}",
            color=0xff7979
        )
        await ctx.send(embed=embed)
...
bot = commands.Bot(
    command_prefix=".",
    description='Music is life :notes::musical_note:',
    intents=intents
)
